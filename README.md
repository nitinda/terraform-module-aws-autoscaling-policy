...
| **_policy\_type_** | _The policy type, either_ **_"SimpleScaling"_**, **_"StepScaling"_** _or_ **_"TargetTrackingScaling"_**_. If this value isn't provided, AWS will default to **_"SimpleScaling"_** | _string_ | **_Optional_** | **_SimpleScaling_** |
